...
public class WristLeRequest extends LeRequest{		


	public WristLeRequest(Context context, BleManagerListener listener) {
		super(context, listener);		
	}

	public WristLeRequest(BleManager bleManager) {
		super(bleManager);		
	}
	...
	public void synDateTime(BluetoothGattCharacteristic gattCharacteristic,
		...
		write16Bytes(gattCharacteristic, send);
	}
	 ...
	 */
	 ...
	 public void promptNotifyNone(BluetoothGattCharacteristic gattCharacteristic,
		 ...
		 tmp[4] = 0x00;
		 write16Bytes(gattCharacteristic, tmp);
	 }
	 ...
	 public void sendImageData(BluetoothGattCharacteristic gattCharacteristic,String text){
		 ...
		 write16Bytes(gattCharacteristic, data);
	 }
	 ...
	 public void sendImageBytes(BluetoothGattCharacteristic gattCharacteristic,byte[] bytes){
		 write16Bytes(gattCharacteristic, bytes);
	 }
