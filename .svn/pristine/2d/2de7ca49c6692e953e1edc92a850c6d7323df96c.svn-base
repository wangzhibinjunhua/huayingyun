 ...
 */
public class HomeGridAdapter extends LoadImageBaseAdapter {

    private Context mContext;

    private ArrayList<HomeMenuBean> devices;

    public HomeGridAdapter(Context context, ArrayList<HomeMenuBean> devices) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //设置设备名
        HomeMenuBean bean = devices.get(position);
