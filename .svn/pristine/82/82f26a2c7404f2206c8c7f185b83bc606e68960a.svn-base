...
public class BleDeviceInfoActivity extends BaseActivity {
    ...
    private TextView txt_date, txt_date1, txt_highPressure, txt_lowPressure, txt_heartRate;
    ...
    private void receiveData(Intent intent) {
        ...
        if (ints != null) {
            ...
            if (ints.length == 15 && isresut == false && ints[2] == 3) {
            ...
            } else if (ints.length == 14 && isresut == false && ints[2] == 3) {
