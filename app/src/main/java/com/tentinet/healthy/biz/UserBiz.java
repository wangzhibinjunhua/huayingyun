...
public class UserBiz extends BaseBiz {
     ...
     * @return 返回服务器响应数据.
     */
    public ResponseBean getCode(String phone) {
        HashMap<String, String> params = getSystemParams(METHOD_GET_CODE);
     ...
     * @return 返回请求提交验证码信息.
     */
    public ResponseBean submitCode(String phone, String code) {
        HashMap<String, String> params = getSystemParams(METHOD_SUBMIT_CODE);
        params.put(KEY_PHONE, phone);
     ...
     */
    public ResponseBean setPassword(String phone, String key, String password) {
        HashMap<String, String> params = getSystemParams(METHOD_SET_PASSWORD);
        params.put(KEY_PHONE, phone);
...
// TODO 需要提交的设备数据 params.put()
        ...
        //   LogUtil.logErrorMessage(String.valueOf(DateUtil.getTimeMillis(data.getDate(), "yyyy-MM-dd HH:mm:ss")));
...
// TODO 需要提交的设备数据 params.put()
     ...
     * @return 返回亲友列表信息.
     */
    public ResponseBean getParentList(String mobile) {
