...
public class LoginActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void changeShowPwd() {
        if (edit_password.getInputType() == InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD) {
            edit_password.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
    ...
    private void saveAccountInfo() {
        TApplication.sp.set(KEY_ACCOUNT, edit_account.getText().toString());
        TApplication.sp.set(KEY_PASSWORD, edit_password.getText().toString());
    }
    ...
    private void getAccountInfo() {
        edit_account.setText(TApplication.sp.get(KEY_ACCOUNT, ""));
        edit_password.setText(TApplication.sp.get(KEY_PASSWORD, ""));
    }
    ...
    private AsynProcessing loginAsyn = new AsynProcessing() {
        ...
        protected Object AsynTask() {
            return biz.login(edit_account.getText().toString(), edit_password.getText().toString());
        }
